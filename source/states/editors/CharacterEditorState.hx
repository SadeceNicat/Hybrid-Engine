...
class CharacterEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	public function new(char:String = null, goToPlayState:Bool = true,?isChartEditor:Bool=false)
	{
		this._char = char;
		this._goToPlayState = goToPlayState;
		this.isChartEditor = isChartEditor;
	...
	override function create()
	{
		...
		upperBox = new PsychUIBox(0, 0, 300, 600, ['File', 'Edit', 'View', "Editors", "Help"],false,26);
