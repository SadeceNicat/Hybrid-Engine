...
class FirstModsMenuState extends MusicBeatState
{
	var bg:FlxSprite;
	var icon:FlxSprite;
	...
	override function create()
	{
		...
		FlxG.save.data.skipModScreen = true;
	...
	var waitingToRestart:Bool = true;
	...
	function reload()
	{
		...
		var curMod:ModItem = modsGroup.members[curSelectedMod];
		MusicBeatState.switchState(new FirstModsMenuState(curMod != null ? curMod.folder : null));
	}
